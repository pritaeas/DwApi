...
if ($testOpen)                                                  // DwApiOpen
{
    ...
    $result = $dwApi->GetMemberArticles(array (94719, 1), null, 2);     // articles for members 1 and 94719, page 2
    $result = $dwApi->GetMemberArticles(array (94719, 1), null, 'a');   // articles for members 1 and 94719, page 1, ignore 'a'
    $result = $dwApi->GetMemberArticles(94719, 17);             // articles for member 94719, forum php
    $result = $dwApi->GetMemberArticles(94719, 17, 2);          // false, only 1 page
